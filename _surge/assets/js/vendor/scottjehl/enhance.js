...
(function( window, undefined ) {
	...
	var doc = window.document,
		...
		var photoswipeCSSKey = "photoswipecss",
		photoswipedefaultskinCSSKey = "photoswipedefaultskincss",
		photoswipeJSKey = "photoswipejs",
		photoswipeuidefaultJSKey = "photoswipeuidefaultjs",
		photoswipeinitJSKey="photoswipeinitjs";
...
for (CSSKey in ['photoswipeCSSKey', 'photoswipedefaultskinCSSKey']) {
	var CSS = getMeta( CSSKey );
	if( CSS && !cookie( CSSKey ) ){
		loadCSS( CSS.content );
		// set cookie to mark this file fetched
		cookie( CSSKey, "true", 7 );
	}	
}
...
for (JSKey in ['photoswipeJSKey', 'photoswipeuidefaultJSKey', 'photoswipeinitJSKey']) {
	var JS = getMeta( JSKey );
	if( JS) ){
		loadJS( JS.content );
	}	
}
